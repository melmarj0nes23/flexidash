  ...
  return (
    <>
      <button 
        ...
        className="w-full md:w-auto justify-center px-4 py-2 text-sm font-medium bg-white dark:bg-[#1b1d22] border border-gray-200 dark:border-[#2a2c33] text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-[#22242a] rounded-md shadow-sm transition-colors flex items-center"
      >
