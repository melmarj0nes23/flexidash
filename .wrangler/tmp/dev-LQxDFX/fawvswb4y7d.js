...
// .wrangler/tmp/bundle-9XjjGx/checked-fetch.js
...
// .wrangler/tmp/pages-tUCO1S/bundledWorker-0.06689865065887246.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let n of ne(t)) !oe.call(e, n) && n !== r && N(e, n, { get: /* @__PURE__ */ __name2(() => t[n], "get"), enumerable: !(s = ae(t, n)) || s.enumerable });
  return e;
}, "ce");
var q = /* @__PURE__ */ __name2((e, t, r) => (r = e != null ? re(ie(e)) : {}, ce(t || !e || !e.__esModule ? N(r, "default", { value: e, enumerable: true }) : r, e)), "q");
var g;
var u = I(() => {
  g = { collectedLocales: [] };
});
...
function L(e, { url: t, cookies: r, headers: s, routeDest: n }) {
  switch (e.type) {
    ...
    case "header":
      return e.value !== void 0 ? A(e.value, s.get(e.key), n) : { valid: s.has(e.key) };
    case "cookie": {
      let i = r[e.key];
      return i && e.value !== void 0 ? A(e.value, i, n) : { valid: i !== void 0 };
    }
    case "query":
      return e.value !== void 0 ? A(e.value, t.searchParams.get(e.key), n) : { valid: t.searchParams.has(e.key) };
  }
}
__name(L, "L");
__name2(L, "L");
...
var T = class {
  ...
  async checkPhase(t) {
    ...
    let n = "miss";
    return s || t === "miss" || t === "error" ? n = "hit" : r && (n = U(t)), this.checkPhase(n);
  }
  async run(t = "none") {
...
async function Me(e, { path: t = "/404", status: r, headers: s, searchParams: n, body: i }, a) {
  ...
  let d = s.normal;
  return w(d, c.headers), w(d, s.important), c = new Response(c.body, { ...c, status: r || c.status, headers: d }), c;
}
__name(Me, "Me");
__name2(Me, "Me");
u();
...
function Ie() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, r) => e.has(r) ? e.get(r) : Reflect.get(globalThis, r), "get"), set: /* @__PURE__ */ __name2((t, r, s) => Ae.has(r) ? Reflect.set(globalThis, r, s) : (e.set(r, s), true), "set") });
}
__name(Ie, "Ie");
__name2(Ie, "Ie");
...
// .wrangler/tmp/pages-tUCO1S/fawvswb4y7d.js
...
// .wrangler/tmp/bundle-9XjjGx/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-9XjjGx/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=fawvswb4y7d.js.map
