...
// .wrangler/tmp/bundle-uw8DfA/checked-fetch.js
...
// .wrangler/tmp/pages-EjeFJc/bundledWorker-0.8614144036725097.mjs
...
var T = class {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: s, cookie: n } } = t, i = n && this.cookies[n], a = U(i ?? ""), o = U(this.reqCtx.request.headers.get("accept-language") ?? ""), p = [...a, ...o].map((y) => s[y]).filter(Boolean)[0];
    if (p) {
...
// .wrangler/tmp/pages-EjeFJc/ss39mq18veg.js
...
// .wrangler/tmp/bundle-uw8DfA/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-uw8DfA/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=ss39mq18veg.js.map
