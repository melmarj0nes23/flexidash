...
var ce = /* @__PURE__ */ __name((e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let n of ne(t)) !oe.call(e, n) && n !== r && V(e, n, { get: /* @__PURE__ */ __name(() => t[n], "get"), enumerable: !(s = ae(t, n)) || s.enumerable });
  return e;
}, "ce");
var $ = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? re(ie(e)) : {}, ce(t || !e || !e.__esModule ? V(r, "default", { value: e, enumerable: true }) : r, e)), "$");
var g;
var u = I(() => {
  g = { collectedLocales: [] };
});
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.7966276815226204.mjs.map
