...
// .wrangler/tmp/bundle-caF1d1/checked-fetch.js
...
// .wrangler/tmp/pages-U7F2Vi/bundledWorker-0.5922110400688484.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let a of ae(t)) !oe.call(e, a) && a !== r && H(e, a, { get: /* @__PURE__ */ __name2(() => t[a], "get"), enumerable: !(s = ne(t, a)) || s.enumerable });
  return e;
}, "ce");
var q = /* @__PURE__ */ __name2((e, t, r) => (r = e != null ? re(ie(e)) : {}, ce(t || !e || !e.__esModule ? H(r, "default", { value: e, enumerable: true }) : r, e)), "q");
var m;
var l = N(() => {
  m = { collectedLocales: [] };
});
...
function j(e, { url: t, cookies: r, headers: s, routeDest: a }) {
  switch (e.type) {
    ...
    case "header":
      return e.value !== void 0 ? I(e.value, s.get(e.key), a) : { valid: s.has(e.key) };
    case "cookie": {
      let i = r[e.key];
      return i && e.value !== void 0 ? I(e.value, i, a) : { valid: i !== void 0 };
    }
    case "query":
      return e.value !== void 0 ? I(e.value, t.searchParams.get(e.key), a) : { valid: t.searchParams.has(e.key) };
  }
}
__name(j, "j");
__name2(j, "j");
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = K(e, me), n = await s.get(a, { softTags: i });
      ...
      case "POST": {
        let i = globalThis[_e], n = /* @__PURE__ */ __name2(async () => {
          let o = await e.json();
          o.data.tags === void 0 && (o.tags ??= K(e, ge) ?? []), await s.set(a, o);
        }, "n");
...
var Ss = { async fetch(e, t, r) {
  ...
  return a.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: b }, async () => i.run({ env: t, ctx: r, cf: e.cf }, async () => {
    if (new URL(e.url).pathname.startsWith("/_next/image")) return W(e, { buildOutput: g, assetsFetcher: t.ASSETS, imagesConfig: f.images });
    let o = B(e);
...
// .wrangler/tmp/pages-U7F2Vi/huc0rm8vu6s.js
...
// .wrangler/tmp/bundle-caF1d1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-caF1d1/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=huc0rm8vu6s.js.map
