...
// .wrangler/tmp/bundle-XCFagT/checked-fetch.js
...
// .wrangler/tmp/pages-yuZvVt/bundledWorker-0.6730725426827141.mjs
...
var $ = /* @__PURE__ */ __name2((e, t, r) => (r = e != null ? re(ie(e)) : {}, ce(t || !e || !e.__esModule ? N(r, "default", { value: e, enumerable: true }) : r, e)), "$");
var g;
var u = I(() => {
  g = { collectedLocales: [] };
});
...
async function E(e, { request: t, assetsFetcher: r, ctx: s }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        a = S(await r.fetch(O(c, e.path ?? n))), e.headers && R(a.headers, e.headers);
        break;
      }
      case "static": {
...
var T = class {
  ...
  applyRouteDest(t, r, s) {
    ...
    return w(this.searchParams, _.searchParams), v(this.path) || (this.path = _.pathname), n;
  }
...
// .wrangler/tmp/pages-yuZvVt/ocaey9ge1ym.js
...
// .wrangler/tmp/bundle-XCFagT/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-XCFagT/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=ocaey9ge1ym.js.map
