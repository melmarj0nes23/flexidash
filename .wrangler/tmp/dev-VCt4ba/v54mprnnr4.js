...
// .wrangler/tmp/bundle-ykF0a8/checked-fetch.js
...
// .wrangler/tmp/pages-amZXGS/bundledWorker-0.8132707629412722.mjs
...
__name(P, "P");
__name2(P, "P");
function O(e, { url: t, cookies: r, headers: s, routeDest: n }) {
  switch (e.type) {
    case "host":
...
async function E(e, { request: t, assetsFetcher: r, ctx: s }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        a = S(await r.fetch(L(c, e.path ?? n))), e.headers && w(a.headers, e.headers);
        break;
      }
      case "static": {
...
var T = class {
  ...
  checkRouteMatch(t, { checkStatus: r, checkIntercept: s }) {
    ...
    }) && !t.missing?.find((a) => O(a, i).valid) && !(r && t.status !== this.status)) {
      if (s && t.dest) {
...
var Le = /* @__PURE__ */ __name2((...e) => {
  ...
  if (!(r === s && typeof t == "object" && t !== null && s in t)) return Oe(...e);
}, "Le");
...
// .wrangler/tmp/pages-amZXGS/v54mprnnr4.js
...
// .wrangler/tmp/bundle-ykF0a8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ykF0a8/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=v54mprnnr4.js.map
