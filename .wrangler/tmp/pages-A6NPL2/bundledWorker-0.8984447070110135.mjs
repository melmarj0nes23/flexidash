...
function Ie() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name((t, a) => e.has(a) ? e.get(a) : Reflect.get(globalThis, a), "get"), set: /* @__PURE__ */ __name((t, a, s) => Ae.has(a) ? Reflect.set(globalThis, a, s) : (e.set(a, s), true), "set") });
}
__name(Ie, "Ie");
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.8984447070110135.mjs.map
