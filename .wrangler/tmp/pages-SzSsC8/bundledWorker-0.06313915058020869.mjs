...
var q = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? re(ie(e)) : {}, ce(t || !e || !e.__esModule ? H(r, "default", { value: e, enumerable: true }) : r, e)), "q");
var m;
var l = N(() => {
  m = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let i = globalThis[_e], n = /* @__PURE__ */ __name(async () => {
          let o = await e.json();
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.06313915058020869.mjs.map
